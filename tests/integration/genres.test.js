...
describe('/api/genres', () => {
    ...
    describe('GET /:id', () => {
        it('should set status 404 if Id is invalid', async () => {
            const res = await request(server).get('/vidly.com/api/genres/1');
            expect(res.status).toBe(404);
        });

        it('should set status 404 if no genre with given id exists', async () => {
        ...
        it('should return a genre if id is valid', async () => {
            ...
            const res = await request(server).get('/vidly.com/api/genres/' + genre.id);
            expect(res.status).toBe(200);
